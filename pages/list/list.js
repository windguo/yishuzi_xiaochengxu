...
Page({
  ...
  getListData: function (classid, page) {
    ...
    console.log(getApp().globalData.roots + '/wxxcx/yishuzishengcheng/lists?classid=' + classid + '&page=' + page)
    wx.request({
      url: getApp().globalData.roots + '/wxxcx/yishuzishengcheng/lists?classid=' + classid + '&page=' + page,
      method: 'GET',
      dataType: 'json',
      success: (json) => {
  ...
  scrolltolowerLoadData: function (e) {
    ...
    wx.request({
      url: getApp().globalData.roots + '/wxxcx/yishuzishengcheng/lists?classid=' + this.data.classid + '&page=' + that.data.page,
      method: 'GET',
      dataType: 'json',
      success: (json) => {
